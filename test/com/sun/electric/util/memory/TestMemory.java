...
public class TestMemory
{
    ...
    public void testEnsmallAndEnlargeMemSize()
    {
        ...
        {
            {
                MemSize.none, MemSize.kilo
            }, 
            {
                MemSize.kilo, MemSize.mega
            },
            {
    ...
    public void testGetMemSize()
    {
        Object[][] mems =
        {
            ...
            {
                MemSize.kilo, (long)(1024)
            },
            {
                MemSize.mega, (long)(1024 * 1024)
            }, 
            {
                MemSize.giga, (long)(1024 * 1024 * 1024)
            },
            {
