...
public class ThreadPool_T
{
    ...
    public void testThreadPoolWithTasks() throws PoolExistsException, InterruptedException
    {
        ...
        LockFreeStack<PTask> taskPool = ConcurrentCollectionFactory.createLockFreeStack();
    ...
    {
        IStructure<PTask> scheduler = ConcurrentCollectionFactory.createLockFreeQueue();
