 ...
 *
 */
public class AStar3_T extends AbstractRoutingBaseClass {

	/* (non-Javadoc)
	 * @see com.sun.electric.tool.routing.kitRouters.AbstractKITRouters#getRoutingFrame()
	 */
	@Override
