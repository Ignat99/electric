...
public class IRSIM implements Engine, IAnalyzer.GUI {
    ...
    /**
     * Method to find the IRSIM module.
     * @return the IRSIM module (null if no IRSIM).
     */
    ...
    public static void runIRSIM(Cell cell, VarContext context, String fileName, IRSIMPreferences ip, boolean doNow) {
        try {
            ...
            IAnalyzer ianalyzer = getInstance();
     ...
     * @param stimuliURL path to stimuli information
     */
    ...
    public void createBus(String busName, IAnalyzer.GuiSignal... subsigs) {
        Signal<DigitalSample>[] sigArray = new Signal[subsigs.length];
     ...
     * This is the same as Character.toLowerCase().
     * @param ch given char.
     * @return canonical char for the given char.
     */
