...
public class SimulationTool extends Tool
{
	...
	public static void restoreStimuli(String fileName)
	{
		...
		{
            FileType fileType = engine.getVectorsFileType();
			fileName = OpenFile.chooseInputFile(fileType, fileType.getName(), null);
			if (fileName == null) return;
		}
    ...
    private static Pref cacheVerilogNoWriteEmptyModules = Pref.makeBooleanPref("VerilogNoWriteEmptyModules", tool.prefs, false);
	 ...
	 * SpiceEngine.SPICE_ENGINE_2 for Spice 2.<BR>
	 * SpiceEngine.SPICE_ENGINE_3 for Spice 3.<BR>
	 * SpiceEngine.SPICE_ENGINE_H for HSpice.<BR>
	 * SpiceEngine.SPICE_ENGINE_P for PSpice.<BR>
	 * SpiceEngine.SPICE_ENGINE_G for GNUCap.<BR>
	 * SpiceEngine.SPICE_ENGINE_S for Smart Spice.<BR>
	 ...
	 * These constants are available: <BR>
	 * SpiceEngine.SPICE_ENGINE_2 for Spice 2.<BR>
	 * SpiceEngine.SPICE_ENGINE_3 for Spice 3. (the default)<BR>
	 * SpiceEngine.SPICE_ENGINE_H for HSpice.<BR>
	 * SpiceEngine.SPICE_ENGINE_P for PSpice.<BR>
	 * SpiceEngine.SPICE_ENGINE_G for GNUCap.<BR>
	 * SpiceEngine.SPICE_ENGINE_S for Smart Spice.<BR>
	...
	/** Get whether or not to use the user-specified spice run directory */
	public static boolean getSpiceUseRunDir() { return cacheSpiceUseRunDir.getBoolean(); }
	/** Set whether or not to use the user-specified spice run directory */
	...
	public static boolean isSpiceWriteEmptySubckts() { return cacheSpiceWriteEmptySubckts.getBoolean(); }
	...
	private static Pref cacheSpiceInputPlaces = Pref.makeBooleanPref("SpiceInputPlaces", tool.prefs, true);
	/** Get whether or not we automatically place cell contents after importing Spice decks */
	public static boolean isSpiceInputPlaces() { return cacheSpiceInputPlaces.getBoolean(); }
