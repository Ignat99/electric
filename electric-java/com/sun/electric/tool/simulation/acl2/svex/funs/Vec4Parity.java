 ...
 * See<http://www.cs.utexas.edu/users/moore/acl2/manuals/current/manual/?topic=SV____4VEC-PARITY>.
 *
 * @param <N> Type of name of Svex variables
 */
public class Vec4Parity<N extends SvarName> extends SvexCall<N>
{
    ...
    public static class Function extends SvexFunction
    {
        ...
        @Override
        public <N extends SvarName> Vec4Parity<N> build(Svex<N>[] args)
        {
        ...
        public Vec4 apply(Vec4... args)
        {
            ...
            if (x.isVec2())
            {
                ...
                if (xv.signum() >= 0)
                {
                    return Vec2.valueOf((xv.bitCount() & 1) != 0);
                }
            }
            return Vec4.X;
        }
