 ...
 */
public class Vec4Plus<N extends SvarName> extends SvexCall<N>
{
    ...
    public static class Function extends SvexFunction
    {
        private Function()
        {
            super(FunctionSyms.CL_PLUS, 2, "4vec-plus");
        }

        @Override
        public <N extends SvarName> Vec4Plus<N> build(Svex<N>[] args)
        {
