 ...
 */
public class Vec4Countones<N extends SvarName> extends SvexCall<N>
{
    public static final Function FUNCTION = new Function();
    public final Svex<N> x;

    private Vec4Countones(Svex<N> x)
    {
        super(FUNCTION, x);
        this.x = x;
    }
    ...
    public static class Function extends SvexFunction
    {
        private Function()
        {
            super(FunctionSyms.SV_COUNTONES, 1, "4vec-countones");
        }

        @Override
        public <N extends SvarName> Vec4Countones<N> build(Svex<N>[] args)
        {
        ...
        public Vec4 apply(Vec4... args)
        {
            ...
            if (x.isVec2())
            {
                ...
                if (xv.signum() >= 0)
                {
                    return Vec2.valueOf(xv.bitCount());
                }
            }
            return Vec4.X;
        }
