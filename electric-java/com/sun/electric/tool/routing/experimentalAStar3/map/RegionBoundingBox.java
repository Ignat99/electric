...
public class RegionBoundingBox extends AStarMapBase<AStarRegionNode>
{
   ...
   * 
   * @return true if all regions are currently not occupied by another search.
   */
  ...
  /**
   * Lets the visitor visit the neighbors of <code>origin</code> in six
   * directions, that is four in the same layer and its neighbors above and
   * below.
   * 
   * @param origin
   * @param visitor
