...
public class Nms2 {
	...
	public static Cell makePart(double sz, StdCellParams stdCell) {
		...
		FoldedMos nmos =
			new FoldedNmos(mosX, nmosY, fw.nbFolds, nbStacked, fw.gateWid,
				           nms2, tech, ep);
		// g2  m1_wid/2 + m1_m1_sp + m1_wid/2
		double g2X = StdCellParams.getRightDiffX(nmos) + 2 + 3 + 2;
		LayoutLib.newExport(nms2, "g2", ep, PortCharacteristic.IN, tech.m1(),
							4, g2X, g2Y);
		// output d  m1_wid/2 + m1_m1_sp + m1_wid/2
		double dX = g2X + 2 + 3 + 2;
		LayoutLib.newExport(nms2, "d", ep, PortCharacteristic.OUT, tech.m1(),
							4, dX, dY);
