...
//	private List<Connection> conList;
	...
	private static class BackAnnotateJob extends Job
    {
        ...
        public boolean doIt() throws JobException
        {
            ...
            TextDescriptor ctd = ep.getPortInstTextDescriptor().withDispPart(TextDescriptor.DispPos.NAMEVALUE);
            TextDescriptor rtd = ep.getArcTextDescriptor().withDispPart(TextDescriptor.DispPos.NAMEVALUE);
            int capCount = 0;
            int resCount = 0;
