...
if (OLD) continue;
	...
	private double getNextDouble()
		throws IOException
	{
		// Java dataInputStream.readLong() will always return big-endian words. Spice3-raw is native byte order.
	...
	private float getNextFloat()
		throws IOException
	{
		// Java dataInputStream.readInt() will always return big-endian integers. Spice3-raw is native byte order.
