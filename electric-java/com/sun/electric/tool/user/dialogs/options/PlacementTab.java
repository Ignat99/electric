...
public class PlacementTab extends PreferencePanel
{
	...
	public void init()
	{
		...
		{
			String algName = an.getAlgorithmName();
			if (algName.equals("General Placement")) continue;
			placementAlgorithm.addItem(algName);
		}
		...
		// show preferences that apply to all placement algorithms
		placementPadding.setText("" + placementOptions.placementPadding);
		placementRunRouting.setSelected(placementOptions.placementRunRouting);
	...
	public void term()
	{
        ...
        placementOptions.placementPadding = TextUtils.atoi(placementPadding.getText());
        placementOptions.placementRunRouting = placementRunRouting.isSelected();
    ...
    private void initComponents()
    {
        ...
        placementPadding = new javax.swing.JTextField();
        placementRunRouting = new javax.swing.JCheckBox();
        ...
        parametersPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("This Placement Algorithm"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("All Placement Algorithms"));
        ...
        placementPadding.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                placementPaddingActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        jPanel1.add(placementPadding, gridBagConstraints);

        placementRunRouting.setText("Run routing after placement");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 2;
        jPanel1.add(placementRunRouting, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 4, 0);
        frame.add(jPanel1, gridBagConstraints);
    ...
    private void placementPaddingActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_placementPaddingActionPerformed
    {//GEN-HEADEREND:event_placementPaddingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_placementPaddingActionPerformed
    ...
    private javax.swing.JTextField placementPadding;
    private javax.swing.JCheckBox placementRunRouting;
