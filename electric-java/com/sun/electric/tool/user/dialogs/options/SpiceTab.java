...
public class SpiceTab extends PreferencePanel
{
	...
	public SpiceTab(PreferencesFrame parent, boolean modal)
	{
		super(parent, modal);
		initComponents();
	...
	public String getName() { return "Spice/CDL"; }
...
//		spiceParasitics.addItem(SimulationTool.SpiceParasitics.RC_PROXIMITY);
		...
		spiceMaxCharsPerLine.setText(SimulationTool.getSpiceMaxCharsPerLine() + "");
	...
	public void term()
	{
		...
		int intNow = TextUtils.atoi(spiceMaxCharsPerLine.getText());
		if (intNow != SimulationTool.getSpiceMaxCharsPerLine()) SimulationTool.setSpiceMaxCharsPerLine(intNow);
	...
	public void reset()
	{
        ...
        if (SimulationTool.getFactorySpiceMaxCharsPerLine() != SimulationTool.getSpiceMaxCharsPerLine())
			SimulationTool.setSpiceMaxCharsPerLine(SimulationTool.getFactorySpiceMaxCharsPerLine());
		...
		// reading spice
		if (SimulationTool.isFactorySpiceInputPlaces() != SimulationTool.isSpiceInputPlaces())
			SimulationTool.setSpiceInputPlaces(SimulationTool.isFactorySpiceInputPlaces());
	}
	...
	private void setSpiceRunOptionsEnabled(boolean enabled) {
		...
		if (enabled)
		{
			// if no use directory specified, disable text box
    ...
    private void initComponents()
    {
        ...
        spiceMaxCharsPerLine = new javax.swing.JTextField();
        ...
        readingSpice = new javax.swing.JPanel();
        spicePlaceAfterReading = new javax.swing.JCheckBox();
        writingCDL = new javax.swing.JPanel();
        cdlBackslash = new javax.swing.JCheckBox();
        ...
        jLabel14.setText("Max chars per line:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 2, 0, 0);
        upperLeft.add(jLabel14, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 4, 0, 4);
        upperLeft.add(spiceMaxCharsPerLine, gridBagConstraints);
        ...
        spiceWriteEmptySubcircuits.setText("Write empty subcircuits");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        readingSpice.setBorder(javax.swing.BorderFactory.createTitledBorder("Reading Spice Deck"));
        readingSpice.setLayout(new java.awt.GridBagLayout());

        spicePlaceAfterReading.setText("Use current placement algorithm after reading");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        readingSpice.add(spicePlaceAfterReading, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        spice.add(readingSpice, gridBagConstraints);

        writingCDL.setBorder(javax.swing.BorderFactory.createTitledBorder("Writing CDL"));
        writingCDL.setLayout(new java.awt.GridBagLayout());

        cdlBackslash.setText("Include \"/\" in instance name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        writingCDL.add(cdlBackslash, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        spice.add(writingCDL, gridBagConstraints);
    ...
    private javax.swing.JCheckBox cdlBackslash;
    ...
    private javax.swing.JPanel readingSpice;
    ...
    private javax.swing.JTextField spiceMaxCharsPerLine;
    ...
    private javax.swing.JCheckBox spicePlaceAfterReading;
    ...
    private javax.swing.JPanel writingCDL;
