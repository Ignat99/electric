...
public class LayerCoverageTool extends Tool
{
    ...
    public static class LayerCoveragePreferences extends PrefPackage {
        ...
        public LayerCoveragePreferences(boolean factory) {
            ...
            if (!factory) seaIfGatesPrefs.getOptionsFromPreferences(false);
        }
                            ...
                            for (PolyBase polyB : set)
                            {
                                ...
                                if (isMerge)
                                {
                                    ...
                                    for(int j=0; j<points.length; j++)
                                        ePoints[j] = EPoint.fromLambda(points[j].getX(), points[j].getY());
                ...
                case NETWORK:
                    {
                        ...
                        Layer.getLayersSortedByRule(list, Layer.LayerSortingType.ByName);
